$(document).ready(function () {
  ...
  $(".review__more").click( function(e) {
    e.preventDefault();
    $(this).siblings('.review__text').addClass('resized');
    $(this).siblings('.review__hide').removeClass('d-none');
    $(this).addClass('d-none');
  });
  
  $(".review__hide").click( function(e) {
    e.preventDefault();
    $(this).siblings('.review__text').removeClass('resized');
    $(this).siblings('.review__more').removeClass('d-none');
    $(this).addClass('d-none');
  });
  ...
  $(".carousel-reviews").owlCarousel({
    ...
    responsive: {
      ...
      767: { items: 1, mouseDrag: true, nav: true, dots: false },  
  ...
  $(".carousel-service").owlCarousel({
    ...
    responsive: {
      0: { items: 1, mouseDrag: false, dots: true, nav: false },
      576: { items: 1, mouseDrag: true, nav: true, dots: false },      
    },
  });
